    ...
    <section className="px-6 py-2 md:py-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-base md:text-xl text-white/90 mb-3 md:mb-6 max-w-2xl mx-auto leading-relaxed px-4">
          Create hilarious prank calls with AI powered voices. <span className="hidden md:inline">Your friends will think it's real! </span>Safe, legal, and absolutely legendary.
        </p>

        <div className="flex flex-row items-center justify-center space-x-2 md:space-x-8 text-white/80 mb-4 md:mb-8 text-xs md:text-base whitespace-nowrap">
          ...
          <div className="flex items-center space-x-0.5 md:space-x-2">
            ...
            <span>5K+ Pranksters</span>
          </div>
          <div className="flex items-center space-x-0.5 md:space-x-2">
            <Star className="w-4 h-4 md:w-5 md:h-5 text-cyan-300" />
